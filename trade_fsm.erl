...
%% player also declares begin ready, the trade is done
ready(OwnPid) ->
...
accept_negotiate(OtherPid, OwnPid) ->
    gen_fsm:send_event(OwnPid, {accept_negotiate, OwnPid}).
...
%% Reply that side is not ready to trade
...
%% but for out purposes, outputting to the shell is enough.
